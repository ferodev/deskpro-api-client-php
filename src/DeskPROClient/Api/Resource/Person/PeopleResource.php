...
class PeopleResource extends AbstractResource
{
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-people-counts
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-people
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#post--api-v2-people
     *
     * @param array $data
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-people-{id}
     *
     * @param int $id
     *
     * @return PersonGetRequest
     */
    public function get($id)
    {
        return new PersonGetRequest($this->context, $this->getEndpoint(), $id);
    }

    /**
     * @see https://support.deskpro.com/api/v2/doc#put--api-v2-people-{id}
     *
     * @param int   $id
     * @param array $data
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#delete--api-v2-people-{id}
     *
     * @param int $id
     *
