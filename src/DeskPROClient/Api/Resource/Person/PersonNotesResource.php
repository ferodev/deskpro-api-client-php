...
/**
 * Class PersonNotesResource.
 */
class PersonNotesResource extends AbstractSubResource
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return "people/{$this->parentId}/notes";
    }

    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-people-{parentId}-notes-counts
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-people-{parentId}-notes
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#post--api-v2-people-{parentId}-notes
     *
     * @param array $data
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-people-{parentId}-notes-{id}
     *
     * @param int $id
     *
     * @return GetRequest
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#put--api-v2-people-{parentId}-notes-{id}
     *
     * @param int   $id
     * @param array $data
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#delete--api-v2-people-{parentId}-notes-{id}
     *
     * @param int $id
     *
