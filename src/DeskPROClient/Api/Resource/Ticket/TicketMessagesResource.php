 ...
 */
class TicketMessagesResource extends AbstractSubResource
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return "tickets/{$this->parentId}/messages";
    }

    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-tickets-{parentId}-messages-counts
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-tickets-{parentId}-messages
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#post--api-v2-tickets-{parentId}-messages
     *
     * @param array $data
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-tickets-{parentId}-messages-{id}
     *
     * @param int $id
     *
     * @return GetRequest
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#put--api-v2-tickets-{parentId}-messages-{id}
     *
     * @param int   $id
     * @param array $data
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#delete--api-v2-tickets-{parentId}-messages-{id}
     *
     * @param int $id
     *
