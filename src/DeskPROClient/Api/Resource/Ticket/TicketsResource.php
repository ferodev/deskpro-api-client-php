 ...
 * Class Tickets.
 */
class TicketsResource extends AbstractResource
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-tickets-counts
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-tickets
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#post--api-v2-tickets
     *
     * @param array $data
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-tickets-{id}
     *
     * @param int $id
     *
    ...
    {
        return new TicketGetRequest($this->context, $this->getEndpoint(), $id);
    }

    /**
     * @see https://support.deskpro.com/api/v2/doc#put--api-v2-tickets-{id}
     *
     * @param int   $id
     * @param array $data
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#delete--api-v2-tickets-{id}
     *
     * @param int $id
     *
