...
/**
 * Class TicketProductsResource.
 */
class TicketProductsResource extends AbstractResource
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-ticket_products-counts
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-ticket_products
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-ticket_products-{id}
     *
     * @param int $id
     *
     * @return GetRequest
