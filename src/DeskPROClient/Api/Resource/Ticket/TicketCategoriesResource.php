...
/**
 * Class TicketCategoriesResource.
 */
class TicketCategoriesResource extends AbstractResource
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-ticket_categories-counts
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-ticket_categories
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-ticket_categories-{id}
     *
     * @param int $id
     *
     * @return GetRequest
