...
/**
 * Class TicketFormsResource.
 */
class TicketFormsResource extends AbstractResource
{
    /**
     * @var string
     */
     ...
     */
    public function __construct(RequestContext $context, $layoutContext)
    {
    ...
    {
        return "ticket_forms/{$this->layoutContext}";
    }

    /**
     * @see https://support.deskpro.com/api/v2/doc#post--api-v2-ticket_forms-{context}
     *
     * @param array $data
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#put--api-v2-ticket_forms-{context}-{id}
     *
     * @param int   $id
     * @param array $data
     *
