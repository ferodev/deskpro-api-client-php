...
/**
 * Class TicketDepartmentsResource.
 */
class TicketDepartmentsResource extends AbstractResource
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-ticket_departments-counts
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#post--api-v2-ticket_departments
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#put--api-v2-ticket_departments-{id}
     *
     * @param int   $id
     * @param array $data
     *
