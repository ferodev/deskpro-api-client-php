...
/**
 * Class TicketWorkflowsResource.
 */
class TicketWorkflowsResource extends AbstractResource
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-ticket_workflows-counts
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-ticket_workflows
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-ticket_workflows-{id}
     *
     * @param int $id
     *
     * @return GetRequest
