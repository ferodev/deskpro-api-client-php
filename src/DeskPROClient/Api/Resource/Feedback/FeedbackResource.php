 ...
 */
class FeedbackResource extends AbstractResource
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-feedback-counts
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-feedback
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-feedback-{id}
     *
     * @param int $id
     *
     * @return GetRequest
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#delete--api-v2-feedback-{id}
     *
     * @param int $id
     *
