...
/**
 * Class FeedbackTypesResource.
 */
class FeedbackTypesResource extends AbstractResource
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-feedback_types-counts
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-feedback_types
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-feedback_types-{id}
     *
     * @param int $id
     *
     * @return GetRequest
