...
class NewsResource extends AbstractResource
{
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-news-counts
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-news
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#post--api-v2-news
     *
     * @param array $data
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-news-{id}
     *
     * @param int $id
     *
     * @return GetRequest
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#put--api-v2-news-{id}
     *
     * @param int   $id
     * @param array $data
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#delete--api-v2-news-{id}
     *
     * @param int $id
     *
