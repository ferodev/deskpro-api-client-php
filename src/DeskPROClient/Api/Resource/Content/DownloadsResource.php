...
class DownloadsResource extends AbstractResource
{
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-downloads-counts
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-downloads
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#post--api-v2-downloads
     *
     * @param array $data
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-downloads-{id}
     *
     * @param int $id
     *
     * @return GetRequest
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#put--api-v2-downloads-{id}
     *
     * @param int   $id
     * @param array $data
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#delete--api-v2-downloads-{id}
     *
     * @param int $id
     *
