...
namespace DeskPROClient\Api\Resource\Organization;
...
use DeskPROClient\Api\Resource\AbstractSubResource;

/**
 * Class OrganizationsNotesResource.
 */
class OrganizationsNotesResource extends AbstractSubResource
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return "organizations/{$this->parentId}/notes";
    }

    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-organizations-{parentId}-notes-counts
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-organizations-{parentId}-notes
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#post--api-v2-organizations-{parentId}-notes
     *
     * @param array $data
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-organizations-{parentId}-notes-{id}
     *
     * @param int $id
     *
     * @return GetRequest
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#put--api-v2-organizations-{parentId}-notes-{id}
     *
     * @param int   $id
     * @param array $data
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#delete--api-v2-organizations-{parentId}-notes-{id}
     *
     * @param int $id
     *
