...
/**
 * Class OrganizationFieldsResource.
 */
class OrganizationFieldsResource extends AbstractResource
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'organization_custom_fields';
    }

    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-organization_custom_fields
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-organization_custom_fields-{id}
     *
     * @param int $id
     *
     * @return GetRequest
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#put--api-v2-organization_custom_fields-{id}
     *
     * @param int   $id
     * @param array $data
     *
