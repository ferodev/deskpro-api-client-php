...
class OrganizationsResource extends AbstractResource
{
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-organizations-counts
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-organizations
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#post--api-v2-organizations
     *
     * @param array $data
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-organizations-{id}
     *
     * @param int $id
     *
    ...
    {
        return new OrganizationGetRequest($this->context, $this->getEndpoint(), $id);
    }

    /**
     * @see https://support.deskpro.com/api/v2/doc#put--api-v2-organizations-{id}
     *
     * @param int   $id
     * @param array $data
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#delete--api-v2-organizations-{id}
     *
     * @param int $id
     *
