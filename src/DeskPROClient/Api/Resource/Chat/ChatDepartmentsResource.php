...
namespace DeskPROClient\Api\Resource\Chat;
...
/**
 * Class ChatDepartmentsResource.
 */
class ChatDepartmentsResource extends AbstractResource
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'chat_departments';
    }

    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-chat_departments-counts
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-chat_departments
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#post--api-v2-chat_departments
     *
     * @param array $data
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#get--api-v2-ticket_departments-{id}
     *
     * @param int $id
     *
     * @return GetRequest
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#put--api-v2-chat_departments-{id}
     *
     * @param int   $id
     * @param array $data
     *
    ...
    /**
     * @see https://support.deskpro.com/api/v2/doc#delete--api-v2-ticket_departments-{id}
     *
     * @param int $id
     *
