...
/**
 * Class AbstractSingleObjectRequest.
 */
abstract class AbstractSingleObjectRequest extends AbstractRequest
{
    /**
     * Resource id.
     *
     ...
     */
    public function __construct(RequestContext $context, $endpoint, $id)
    {
