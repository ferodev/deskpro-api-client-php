...
/**
 * @mixin \DeskPROClient\Api\Request\UploadRequest
 */
class UploadRequestSpec extends ObjectBehavior
{
    public function let(RequestContext $context, Client $httpClient)
    {
        $this->beConstructedWith($context, 'my_endpoint', 'my_file.txt', 'data_string');
    ...
    {
        $this->getFilename()->shouldReturn('my_file.txt');
    }

    public function it_returns_payload()
    {
        $this->getData()->shouldReturn('data_string');
    }
}
