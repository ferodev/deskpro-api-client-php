...
/**
 * @mixin \DeskPROClient\Api\Request\FindRequest
 */
class FindRequestSpec extends ObjectBehavior
{
    ...
    public function it_converts_all_query_params()
    {
        $this
            ->sideload('person')
            ->orderBy('id')
        ...
        $this->getUrl()->shouldReturn('http://helpdesk.url/api/v2/my_endpoint?label=label_1&order_by=id&order_dir=desc&page=10&count=100&include=person');
    }

    public function it_converts_criteria_to_query_params()
    {
        $this
            ->criteria([
                'label' => 'label_1',
        ...
        $this->getUrl()->shouldReturn('http://helpdesk.url/api/v2/my_endpoint?label=label_1');
    }
}
